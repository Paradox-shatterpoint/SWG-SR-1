...
kaas_regions = {
  ...
  {"a_rebel_outpost_01",-6131,2705,{1,2000},NOBUILDZONEAREA},  -- kaas city

        {"borgle_bat_cave",2850,3890,{1,200},NOSPAWNAREA + NOBUILDZONEAREA}, -- smuggler op
        {"borgle_bat_cave_01",2850,3890,{1,700},NOBUILDZONEAREA}, -- smuggler op
        {"borgle_bat_cave_02",-5117,-2293,{1,200},NOSPAWNAREA + NOBUILDZONEAREA}, -- garrison
        {"borgle_bat_cave_03",-5117,-2293,{1,1500},NOBUILDZONEAREA}, -- garrison
         
        {"camp_and_BH",3342,2634,{1,200},NOSPAWNAREA + NOBUILDZONEAREA}, --gundark cave
        {"camp_and_BH_02",3342,2634,{1,500},NOBUILDZONEAREA}, --gundark cave
        {"camp_and_BH_01",-6135,6575,{1,200},NOSPAWNAREA + NOBUILDZONEAREA}, --mailoc cave
        {"camp_and_BH_03",-6135,6575,{1,500},NOBUILDZONEAREA}, --mailoc cave
        ...
        {"cobral_tent_01",-70,6370,{1,1000},NOBUILDZONEAREA}, -- ruined sith complex
        {"cobral_tent_02",-1119,4767,{1,100},NOSPAWNAREA + NOBUILDZONEAREA}, -- Dark Force Shrine
        {"cobral_tent_03",-1119,4767,{1,1000},NOBUILDZONEAREA}, -- Dark Force Shrine
