...
moraband_regions = {
	{"Korriban Outpost",-1736,-640,{1,300},NOSPAWNAREA + NOBUILDZONEAREA,1},
	{"world_spawner",0,0,{1,-1},SPAWNAREA + WORLDSPAWNAREA,{"moraband_world","global"},2048},

}

moraband_static_spawns = {
