...
object_building_faction_perk_hq_hq_s03_rebel = object_building_faction_perk_hq_shared_hq_s03_rebel:new {
		...
		childCreatureObjects = {
			{ mobile="at_xt", x=35, z=0, y=32, cellid=-1, respawn=600, containmentType=-1, heading=3.14},
		 	{ mobile="at_xt", x=-35, z=0, y=32, cellid=-1, respawn=600, containmentType=-1, heading=0},
